"""
Just copy and paste the code from one of the examples into the following file and it allows yo to run it on pycharm.
"""
import numpy as np
...
for name, im_test in zip(method_names, [im_test1, im_test2, im_test3]):
    ...
    """
    The below block was not printing the variables at the end for the data, but it was not 
    necessarily formatted for this python version, but with a few tweaks it works as intended.
    """
    print("Method:", name)
    print("Adapted Rand error:", error)
    print("Adapted Rand precision:", precision)
    print("Adapted Rand recall:", recall)
    print("False Splits:", splits)
    print("False Merges:", merges)
